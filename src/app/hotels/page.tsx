...
const HOTELS = [
  ...
  },
  {
    ...
    price: 'השאירו פרטים למחיר מדויק'
  }
];
...
export default function HotelsPage() {
  return (
    <div className="flex flex-col min-h-screen bg-white">
      <PageHeader 
        title="מלונות וריזורטים" 
        subtitle="הבית שלכם הרחק מהבית. קולקציית המלונות הנבחרת שלנו נבדקה בקפידה כדי להבטיח נוחות, שירות ומיקום מנצח."
        imageSrc="/images/hero_hotels.png"
        imageAlt="ריזורט יוקרתי בשעת עומד בשקיעה"
      />
