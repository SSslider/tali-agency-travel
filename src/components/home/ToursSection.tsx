...
export function ToursSection() {
  return (
    <section id="tours" className="py-24 bg-tal-offwhite scroll-mt-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8 space-y-8">
            <div className="flex justify-between items-end mb-8 border-b border-gray-200 pb-4">
              <h2 className="text-3xl font-serif font-bold text-tal-navy">טיולים מאורגנים קרובים</h2>
            ...
            {TOURS.map((tour, idx) => (
              ...
              >
                <div className="w-full sm:w-2/5 h-64 sm:h-auto relative overflow-hidden shrink-0">
                  ...
                  />
                  <div className={`absolute top-4 right-4 ${tour.statusColor} px-3 py-1.5 rounded-full text-xs font-bold leading-none backdrop-blur-sm animate-pulse`}>
                    {tour.status}
                  </div>
                </div>
                ...
                <div className="p-6 flex flex-col flex-1 pl-8">
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-gray-100 mt-auto">
                    <span className="font-bold text-red-600 text-sm md:text-base font-sans animate-pulse">
                      ההרשמה נסגרת בקרוב!
                    </span>
                    <Link 
                      href="/#contact" 
          ...
          <div className="lg:col-span-4">
            <div className="bg-white shadow-lg p-8 rounded-3xl sticky top-28">
